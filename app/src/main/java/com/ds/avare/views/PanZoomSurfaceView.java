...
public class PanZoomSurfaceView extends GLSurfaceView {
    ...
    public PanZoomSurfaceView(Context context) {
        super(context);
        setup(context);
    }

    public PanZoomSurfaceView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setup(context);
    }
