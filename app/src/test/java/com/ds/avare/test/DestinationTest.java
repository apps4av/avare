...
@PrepareForTest({StorageService.class, PreferenceManager.class, GeomagneticField.class, Destination.class}) //class which creates the instance
public class DestinationTest {
    ...
    public void testUpdateTo() throws Exception {
        ...
        // mock calendar set to 12:00 for ETA time calcs
        Mockito.when(mockCalendar.get(Calendar.HOUR_OF_DAY)).thenReturn(12);
        Mockito.when(mockCalendar.get(Calendar.MINUTE)).thenReturn(0);
        setField(d, "sCalendar", mockCalendar);
        ...
        assertEquals(d.getEte(), "00.00");
        assertEquals(d.getEta(), "12:00");
        ...
        assertEquals(d.getEte(), "01:00"); //... at 60kt we should be there in 1h
        assertEquals(d.getEta(), "13:00");
    }
